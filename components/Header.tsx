...
export default function Header() {
    ...
    return (
        <header className="bg-blue-600 text-white py-4 shadow-md px-4 flex justify-between items-center">
            <div id="header-title" className="text-2xl">
                <h1 className="text-2xl font-bold">TA</h1>
                <hr className="border-t border-gray-300" />
            </div>
            <nav className="max-w-4xl mx-auto px-4 flex justify-between items-center max-sm:hidden">
